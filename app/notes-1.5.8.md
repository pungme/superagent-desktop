...
- **Switching model now actually switches.** Picking "Default" on a chat that had been running Fable used to stay on Fable — the switch didn't take on a resumed conversation. It now always applies.
